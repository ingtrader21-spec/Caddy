...
EXPECTED_KEYCLOAK_SHA = "45a487d71a516ae3039b00c250752897469ffe7a"
EXPECTED_GATE_NAMES = {
    "PAS-162",
    "PAS-145",
    "PR175_EXACT_HEAD_CI",
...
def validate_candidate(candidate: dict[str, Any]) -> None:
    ...
    require(
        prepared.get("merged_main_sha") is None,
        "merged main SHA must remain null before PR #175 merges",
    )
...
def validate_evidence_template(evidence: dict[str, Any]) -> None:
    ...
    require(
        ...
        "merged source must be populated only after PR #175 merges",
    )
