...
## 0. 2026-09-20 convergence update — current authority

This document originated as the 2026-09-18 audit baseline. The freeze-state findings below are retained as historical evidence; the successor branch uses the current authority below.

```text
CADDY_MAIN_SHA=84c2b7b3bce6d90764eac5eab362aed973f56056
CADDY_SUCCESSOR_BRANCH=converge/caddy-v3-final-20260920
MIDDLEWARE_MAIN_SHA=2862af0aa97367b18cb360af69212abe4243a1ac
MIDDLEWARE_V3_CONTRACT_SHA256=9c32daecd4a15104c6f9ff60ce19c8f7e78707fb31d9fd9fcb55b1b8dfa3512b
MIDDLEWARE_V3_ROUTE_COUNT=117
MIDDLEWARE_RELEASE_AUTHORITY=MERGED
CADDY_PRIVATE_METRICS_DENIAL=IMPLEMENTED_LOCALLY
CADDY_PRIVATE_INTERNAL_DENIAL=IMPLEMENTED_LOCALLY
CADDY_IDENTITY_HEADER_SANITATION=IMPLEMENTED_LOCALLY
KONG_MAIN_SHA=5ac254c6fb04579615e4d60d25efcc911d42a2e3
KONG_CONTRACT_SHA256=7580123dead97ea342c704a57a3c8eed9f5dce69aab247d4b693db96bc7334d5
KONG_V3_REPIN_REQUIRED=YES
RUNTIME_APPLY_AUTHORIZED=NO
PRODUCTION_GO=NO
```

The Middleware source contract is frozen on protected main. Caddy can converge source against V3, while cross-repo certification remains gated on Kong re-pinning the same 9c32daec... contract. No Caddy source merge alone authorizes a production reload or cutover.

## 1. Historical hard start gate at 2026-09-18 — NOT SATISFIED THEN
